...
<section class="am-dashboard">
    <div class="container am-container">
        <div class="am-dashboard-hero mb-4">
            ...
            <p class="mb-0" style="color:rgba(255,255,255,.82);">Créez une fiche claire avec prix, stock, catégorie et description.</p>
        </div>
        ...
        <div class="am-panel">
            <form method="POST" action="{{ request()->routeIs('admin.*') ? route('admin.produits.store') : route('produits.store') }}" enctype="multipart/form-data" class="d-grid gap-3">
                    ...
                    <div class="am-field">
                        ...
                        <select id="categorie_id" name="categorie_id" required>
                            ...
                            @foreach($categories as $categorie)
                                ...
                                <option value="{{ $categorie->id }}" @selected(old('categorie_id') == $categorie->id)>{{ $categoryName }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="am-field">
                ...
                @include('public.produits.partials.image-field')
                <div>
